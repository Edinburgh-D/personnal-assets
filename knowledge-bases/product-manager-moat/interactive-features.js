...
/* ===== Language Switcher ===== */
var LANG_MAP = {
    'nav.menu':           { zh: '目录',      en: 'Menu' },
    'nav.home':           { zh: '首页',      en: 'Home' },
    'nav.dark':           { zh: '暗色',      en: 'Dark' },
    'nav.light':          { zh: '亮色',      en: 'Light' },
    'nav.print':          { zh: '打印',      en: 'Print' },
    'nav.section.overview': { zh: '总览',    en: 'Overview' },
    'nav.section.depth':    { zh: '深入',    en: 'In Depth' },
    'nav.section.navigate': { zh: '导航',    en: 'Navigate' },
    'nav.section.onpage':   { zh: '本页',    en: 'On This Page' },
    'search.placeholder':   { zh: '搜索...', en: 'Search...' },
    'search.find':          { zh: '查找',    en: 'Find' },
    'search.clear':         { zh: '清除',    en: 'Clear' },
    'bm.add':               { zh: '+BM',     en: '+BM' },
    'bm.remove':            { zh: 'BM',      en: 'BM' },
    'bm.title':             { zh: '书签',    en: 'Bookmarks' },
    'bm.clear':             { zh: '清空全部', en: 'Clear all' },
    'sidebar.title':        { zh: '本页目录', en: 'On This Page' },
    'section.further':      { zh: '延伸阅读', en: 'Further Reading' },
    'table.page':           { zh: '页面',    en: 'Page' },
    'table.content':        { zh: '内容',    en: 'Content' },
...
function createLangSwitcher() {
    ...
    btn.addEventListener('click', function() { window.switchLang(); });
